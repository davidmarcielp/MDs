---
title: >-
  Cambio sobre el swagger. MasMovil Ticketing API - Inbound (External Systems >
  MasMovil)
language_tabs:
  - java: Java
  - go: Go
...
<h1 id="cambio-sobre-el-swagger-masmovil-ticketing-api-inbound-external-systems-masmovil-">Cambio sobre el swagger. MasMovil Ticketing API - Inbound (External Systems > MasMovil) v2.2.2</h1>

> cambio 2 sobre el MD. Scroll down for code samples, example requests and responses. Select a language for code samples from the tabs above or the mobile navigation menu.
...
<h1 id="cambio-sobre-el-swagger-masmovil-ticketing-api-inbound-external-systems-masmovil--ticket">Ticket</h1>
