...
<h1 id="masmovil-ticketing-api-inbound-external-systems-masmovil-">MasMovil Ticketing API - Inbound (External Systems > MasMovil) v1.1.1</h1>

> Cambio sobre el MD- Scroll down for code samples, example requests and responses. Select a language for code samples from the tabs above or the mobile navigation menu.
