...
<h1 id="cross-recibos">CROSS - RECIBOS v3.4.4</h1>

> Scroll down for code samples, example requests and responses. Select a language for code samples from the tabs above or the mobile navigation menu.

CAMBIO 10  API que recoge todas las funcionalidades relativas a los recibos gestionados por la Mutua Madrileña Muy Madrileña en su distintos.   
...
```java
<<<<<<< DRAFT/en/docs/carpeta1_doc_swagger/3/3.4.4__carpeta1_doc_swagger.md
URL obj = new URL("https://$(catalog.host)/cross-recibos/api/v1/polizas/{id-poliza}/recibos?desdeFecha=2020-05-25&hastaFecha=2020-05-25");
=======
URL obj = new URL("https://$(catalog.host)/cross-recibos/api/v1/polizas/{id-poliza}/recibos?desdeFecha=2020-04-16&hastaFecha=2020-04-16");
>>>>>>> PUBLISH/en/docs/carpeta1_doc_swagger/3/3.4.3__carpeta1_doc_swagger.md
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("GET");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
<<<<<<< DRAFT/en/docs/carpeta1_doc_swagger/3/3.4.4__carpeta1_doc_swagger.md
fetch('https://$(catalog.host)/cross-recibos/api/v1/polizas/{id-poliza}/recibos?desdeFecha=2020-05-25&hastaFecha=2020-05-25',
{
  method: 'GET',
...
$.ajax({
  ...
  method: 'get',
  data: '?desdeFecha=2020-04-16&hastaFecha=2020-04-16',
  headers: headers,
...
```java
<<<<<<< DRAFT/en/docs/carpeta1_doc_swagger/3/3.4.4__carpeta1_doc_swagger.md
URL obj = new URL("https://$(catalog.host)/cross-recibos/api/v1/recibos-by-nif?fechaConsulta=2020-05-25");
=======
URL obj = new URL("https://$(catalog.host)/cross-recibos/api/v1/recibos-by-nif?fechaConsulta=2020-04-16");
>>>>>>> PUBLISH/en/docs/carpeta1_doc_swagger/3/3.4.3__carpeta1_doc_swagger.md
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("GET");
int responseCode = con.getResponseCode();
...
<<<<<<< DRAFT/en/docs/carpeta1_doc_swagger/3/3.4.4__carpeta1_doc_swagger.md
fetch('https://$(catalog.host)/cross-recibos/api/v1/recibos-by-nif?fechaConsulta=2020-05-25',
{
  method: 'GET',
...
<h2 id="tocS_DatosCobro">DatosCobro</h2>
<!-- backwards compatibility -->
...
<h2 id="tocS_FrecuenciaPago">FrecuenciaPago</h2>
<!-- backwards compatibility -->
