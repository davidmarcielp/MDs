...
<<<<<<< DRAFT/carpeta1_doc_swagger/2.md
CAMBIO 11! API que recoge todas las funcionalidades relativas a los recibos gestionados por la Mutua Madrileña en suuu distintos ramos.
=======
CAMBIO 2!
...
>>>>>>> PUBLISH/carpeta1_doc_swagger/1.md
...
```java
URL obj = new URL("https://$(catalog.host)/cross-recibos/api/v1/polizas/{id-poliza}/recibos?desdeFecha=2020-03-31&hastaFecha=2020-03-31");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("GET");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
$.ajax({
  ...
  method: 'get',
  data: '?desdeFecha=2020-03-31&hastaFecha=2020-03-31',
  headers: headers,
  success: function(data) {
    console.log(JSON.stringify(data));
  }
...
```java
URL obj = new URL("https://$(catalog.host)/cross-recibos/api/v1/recibos-by-nif?fechaConsulta=2020-03-31");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("GET");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
